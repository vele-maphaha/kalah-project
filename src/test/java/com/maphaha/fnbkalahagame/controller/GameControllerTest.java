...
public class GameControllerTest {
    ...
    public void shouldInitGame() throws Exception {
        ...
        mockMvc.perform(initGameRequest)
                ...
                //check player index
                .andExpect(MockMvcResultMatchers.jsonPath("$.player1.playerIndex").value(GameControllerTest.PLAYER1_INDEX))
                .andExpect(MockMvcResultMatchers.jsonPath("$.player2.playerIndex").value(GameControllerTest.PLAYER2_INDEX))

                //check pit owner
                .andExpect(MockMvcResultMatchers.jsonPath("$.board.pits.6.playerIndex").value(GameControllerTest.PLAYER1_INDEX))
                .andExpect(MockMvcResultMatchers.jsonPath("$.board.pits.13.playerIndex").value(GameControllerTest.PLAYER2_INDEX))
                .andExpect(MockMvcResultMatchers.jsonPath("$.board.pits.14.playerIndex").value(GameControllerTest.PLAYER2_INDEX))

                //check  initial pit stone count
                .andExpect(MockMvcResultMatchers.jsonPath("$.board.pits.5.stoneCount").value(GameControllerTest.INITIAL_STONE_ON_PIT))
                .andExpect(MockMvcResultMatchers.jsonPath("$.board.pits.12.stoneCount").value(GameControllerTest.INITIAL_STONE_ON_PIT))
                .andExpect(MockMvcResultMatchers.jsonPath("$.board.pits.14.stoneCount").value(GameControllerTest.INITIAL_STONE_ON_HOUSE))
